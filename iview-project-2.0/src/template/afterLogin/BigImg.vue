<template>
    ...
    <transition name="fade" >
        ...
        <div class="img-view" @click="bigImg" ref="view" >
            <!-- 遮罩层 -->
            <div class="img-layer" @click="cancelShow"></div>
              <canvas 
                id="canvas"
            ...
            <div id="tool" >
	              <div id="getPaint" @click="getPaint">画笔</div>
	              <div id="write" @click="toolwrite">文本</div>
	              <div id="back" @click="back">撤销</div>
            </div>
...
export default {
  ...
  mounted() {
    ...
    img_layer.style.height = clientHeight*2+'px';
    


    // this.$refs.view.style.height =clientHeight+'px';
    // this.$refs.view.style.width =clientWidth+'px';
    ...
    canvas.height = clientHeight*1.2; //设置canvas画布高度
  ...
  methods: {
    ...
    write:function (ev) {
      ...
      this.inY = ev.clientY-canvas.offsetTop;
    ...
    paint:function (ev) { // onmousedown
      ...
      canvas.onmousemove = function(ev) {
        ...
        var targetY = ev.clientY - canvas.offsetTop;
