...
class TeachersFileActivity : BaseActivity(), Contract.View {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerview_teachersfile_list.layoutManager = LinearLayoutManager(this)

        setActionBar()
    }

    fun setActionBar() {
        img_teachersfile_own.setOnClickListener{
    ...
    override fun setAdapter(adapter: RecyclerView.Adapter<RecyclerView.ViewHolder>) {
        recyclerview_teachersfile_list.adapter = adapter
    }
